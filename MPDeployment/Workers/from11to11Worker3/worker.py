...
WORKER_ID = os.getenv("WORKER_ID", "11_11_3")  # Unique ID for each worker
INPUT_SHAPE = [1, 256, 15, 15]  # Shape of the model input
INPUT_NAME = "vgg0_pool2_fwd"  # Model input name

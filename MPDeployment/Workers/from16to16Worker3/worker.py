...
WORKER_ID = os.getenv("WORKER_ID", "16_16_3")  # Unique ID for each worker
INPUT_SHAPE = [1, 512, 8, 8]  # Shape of the model input
INPUT_NAME = "vgg0_pool3_fwd"  # Model input name
